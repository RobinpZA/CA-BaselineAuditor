<#
.SYNOPSIS
    Build script for CA-BaselineAuditor. Bootstraps dependencies and runs build tasks.
.PARAMETER Task
...
$moduleName = 'CA-BaselineAuditor'
$buildDir = Join-Path $PSScriptRoot 'build' $moduleName
$sourceFiles = @(
    'CA-BaselineAuditor.psd1'
    'CA-BaselineAuditor.psm1'
    'Public'
    'Private'
    'Assets'
    'Config'
...
Write-Host "CA-BaselineAuditor Build Script" -ForegroundColor Cyan
